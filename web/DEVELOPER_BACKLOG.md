...
Фактическое состояние issues на момент обновления: #1–#8 и #37–#39 закрыты; #9–#22, #44 и D01/#46 открыты. T02–T08C последовательно интегрированы и проверены на общем `main`. Текущий ограниченный приоритет владельца — D01/#46 в открытом PR #47; один финальный cloud/ink/blue/cyan язык дорабатывается без переноса на остальные экраны. Внешний блокер не разрешает обходить security gate.
