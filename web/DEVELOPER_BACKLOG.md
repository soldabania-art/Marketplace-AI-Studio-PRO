...
Фактическое состояние issues на момент обновления: #1–#8 и #37–#39 закрыты; #9–#22, #44 и D01/#46 открыты. T02–T08C последовательно интегрированы и проверены на общем `main`. Текущий ограниченный приоритет владельца — D01/#46 в открытом PR #47; визуальное направление не принято, синяя версия сохранена как контроль, сравниваются два самостоятельных арт-направления A/B. Внешний блокер не разрешает обходить security gate.
