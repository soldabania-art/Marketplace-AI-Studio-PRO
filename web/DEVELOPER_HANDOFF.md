...
- D01 продолжается в открытом PR #47. **Направление B выбрано; итоговая реализация ожидает приёмки.** B развивается как связанный маршрут главная → возможности и площадки → подключение WB → AI Director. A и синяя версия на `7326b9fb759f463515948e548841804dbc23ace1` сохранены как контрольные; до приёмки стиль не распространять на остальные экраны.
