...
- D01 продолжается в открытом PR #47. Визуальное направление **не принято**: решение о синей палитре отменено владельцем. Синяя версия на head `7326b9fb759f463515948e548841804dbc23ace1` сохранена как контрольная (`variant=control`); для сравнения готовятся два самостоятельных арт-направления A/B с одинаковой историей и демо-данными. До выбора направления изменения не распространять на остальной продукт.
...
Текущая работа — только [D01/#46](https://github.com/soldabania-art/Marketplace-AI-Studio-PRO/issues/46), PR #47: сравнение двух существенно разных арт-направлений и сохранённого контрольного прототипа на синтетических данных. [Визуальное решение и варианты](D01_VISUAL_REFERENCE.md). Для A/B проверяются первый экран и содержательная инфографика на desktop 1440, а также карточка Director на mobile 390. Дизайн-PR не сливать и не переносить стиль на весь продукт до выбора владельца и визуальной приёмки главного архитектора.
