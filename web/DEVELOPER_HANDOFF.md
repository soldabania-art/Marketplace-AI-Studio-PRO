...
- D01 продолжается в открытом PR #47. **Направление B выбрано; итоговая реализация ожидает приёмки.** Реализован связанный маршрут главная → возможности и площадки → подключение WB → AI Director. A и синяя версия на `7326b9fb759f463515948e548841804dbc23ace1` сохранены как контрольные. Финальный browser capture [run #34739691996](https://github.com/soldabania-art/Marketplace-AI-Studio-PRO/actions/runs/34739691996) штатно выбрал «Только обязательные», прошёл маршрут и сформировал отдельные PNG первого посещения/home/capabilities/connect/Director desktop/mobile, WebM и `browser-report.json` в `docs/design/d01/selected-b/final-acceptance`; до приёмки стиль не распространять на остальные экраны.
...
Текущая работа — только [D01/#46](https://github.com/soldabania-art/Marketplace-AI-Studio-PRO/issues/46), PR #47. Направление B выбрано владельцем и главным архитектором; итоговая реализация ожидает визуальной приёмки. Финальный capture подтвердил маршрут на 1440, 1280 и 390 px, порядок mobile Director, размеры текста, физический cookie-consent click, все состояния, keyboard focus, reduced motion, отсутствие overflow и runtime errors. Дизайн-PR не сливать и не переносить стиль на весь продукт до приёмки.
