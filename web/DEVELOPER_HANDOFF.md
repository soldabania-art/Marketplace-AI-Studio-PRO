...
- D01 продолжается в открытом PR #47. Рекомендуемое направление Operational Ledger усилено trace-знаком и картой «источники → решение → результат»; добавлены честные статусы площадок, локальные реакции и отдельная mobile-композиция. Суммы/проценты условны и подписаны как демо; расход, прибыль и эффект действия не смешиваются.
...
Текущая работа — только [D01/#46](https://github.com/soldabania-art/Marketplace-AI-Studio-PRO/issues/46), PR #47: два визуальных направления и связанный синтетический prototype главная → подключение → AI Director. [Визуальное решение и tokens](D01_VISUAL_REFERENCE.md). Desktop 1440, laptop 1280 и mobile 390 проверяются реальным Chromium; browser artifacts хранятся в `docs/design/d01`. Дизайн-PR не сливать и не переносить стиль на весь продукт до визуальной приёмки главного архитектора.
