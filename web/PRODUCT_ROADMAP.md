...
| Business profiles / onboarding | Store-scoped assessment, resumable first import, confirmed profile, evidence summary and profile-aware costing requirements implemented | Confirm per-SKU cost inputs and accounting-source mappings |
