...
| Business profiles / onboarding | Store-scoped assessment, resumable first import, confirmed profile, evidence summary and profile-aware costing requirements implemented | Source-specific mapping UI and automatic document imports |
...
| Profit Center | WB ledgers, verified COGS components, immutable bulk-import preview/commit and tax, complete/partial P&L | Production reconciliation and certified accounting adapters |
