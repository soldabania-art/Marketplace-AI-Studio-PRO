...
| Business profiles / onboarding | Store-scoped assessment, resumable first import, confirmed profile, evidence summary and profile-aware costing requirements implemented | Accounting-source mappings and automatic document imports |
...
| Profit Center | WB finance + advertising ledgers, profile-aware verified COGS components + tax, complete/partial P&L by SKU/store | Production reconciliation and accounting-source COGS/tax imports |
