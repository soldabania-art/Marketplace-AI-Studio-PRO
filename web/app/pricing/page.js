...
const plans = [
  { code:'trial', name: 'Пробный запуск', price: '0 ₽', note: '3 дня с первого AI-анализа', features: ['До 5 карточек', '1 магазин и 1 пользователь', 'Фото, тексты, SEO и экономика', 'Без автоматических изменений магазина'] },
