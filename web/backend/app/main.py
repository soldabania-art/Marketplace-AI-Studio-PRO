...
app=FastAPI(title=settings.app_name,version='0.22.0',description='TROVENDI backend',lifespan=lifespan)
...
def health(): return {'status':'ok','service':'marketplace-ai-studio-api','version':'0.22.0','environment':settings.environment,'embedded_fbo_monitor':settings.run_fbo_monitor_in_api}
...
def ready():
    ...
    return {'status':'ready','database':'ok','version':'0.22.0'}
