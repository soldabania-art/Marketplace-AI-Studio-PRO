...
app=FastAPI(title=settings.app_name,version='0.15.0',description='Backend for Marketplace AI Studio Cloud',lifespan=lifespan)
...
def ready():
    ...
    return {'status':'ready','database':'ok','version':'0.15.0'}
