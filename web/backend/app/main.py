...
def health(): return {'status':'ok','service':'trovendi-api','version':'0.29.0','environment':settings.environment,'embedded_fbo_monitor':settings.run_fbo_monitor_in_api}
...
def ready():
    ...
    return {'status':'ready','database':'ok','version':'0.29.0'}
